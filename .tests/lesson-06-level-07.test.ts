...
import def from "../lesson-06-js-syntax/level-07-declare-objects/script.js";

const file = path.join(
  process.cwd(),
  "lesson-06-js-syntax",
  "level-07-declare-objects",
  "script.js",
);
const src = fs.readFileSync(file, "utf8");

describe("lesson-06 — level-07 declare objects", () => {
  it("declares at least 10 object literals (declared and initialized on one line)", () => {
  ...
  it("exports one object as the default export", () => {
